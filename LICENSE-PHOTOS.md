...
Every photograph in this repository — the image files in `app/content/images/` and the
portrait `app/content/dp.jpg`, together with the resized and reformatted copies the build
generates from them — is licensed under
